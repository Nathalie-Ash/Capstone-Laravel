    ...
    <main class="main-content">
        <div class="container">
            <div class="row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" readonly class="form-control-plaintext"
                                                    ...
                                                    value="{{ $sharedContact->phone_number }}">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                ...
                <div class="col" id="div1" style="width: 206%;border-radius: 10px;height: max-content; ">
                    Timetable
